...
### Others
parser.add_argument('--speech_encoder_pretrain',  type=str,   default="/home/users/nus/e1342275/TSVAD_pytorch/ts-vad/pretrained_models/WavLM-Base+.pt",  help='Path of the pretrained speech_encoder')
...
if args.train == True:
	while args.epoch < args.max_epoch:
		...
		if args.epoch % args.test_step == 0:
			...
			if args.epoch in [12,18,30,32,35,38,41,44,47,50,52,54,56,58]:
				s.eval_network(args)
		args.epoch += 1
	quit()
