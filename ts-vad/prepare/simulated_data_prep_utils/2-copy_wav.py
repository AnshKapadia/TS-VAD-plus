...
parent_dir = '/home/users/nus/e1342275/scratch/v2_simulated_data_Switchboard_SRE_small_16k/data/simu3'
    ...
    if dir in wav_dirs:
        ...
        for sub_dir in os.listdir(os.path.join(parent_dir, 'wav', dir)):
            ...
            for file in os.listdir(os.path.join(parent_dir, 'wav', dir, sub_dir)):
                ...
                dst = os.path.join(wavs_dir, f'data_simu3_wav_{dir}_{sub_dir}_{file}')
